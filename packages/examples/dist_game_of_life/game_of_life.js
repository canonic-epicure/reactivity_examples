...
class Application extends Component {
    ...
    render() {
        return ChronoGraphJSX.createElement("div", { class: "gol-application" },
            ChronoGraphJSX.createElement("div", { class: "gol-grid" }, () => {
                this.flush;
                return this.cells.map((row, r) => ChronoGraphJSX.createElement("div", { class: "gol-row" }, row.map((cell, c) => ChronoGraphJSX.createElement("div", { class: "gol-cell", "class:gol-cell--alive": () => cell.readProposedOrPrevious() === 1, title: `(${r}, ${c})` }))));
            }),
            ChronoGraphJSX.createElement("div", { class: "gol-toolbar" },
                ChronoGraphJSX.createElement("button", { type: "button", class: "gol-btn", "on:click": () => {
                        globalGraph.commit();
                        for (let r = 0; r < this.rows; r++) {
                            for (let c = 0; c < this.cols; c++)
                                this.cells[r][c].write(this.nextGrid[r][c]);
                        }
                        this.flush++;
                        // @ts-ignore
...
// @ts-ignore
const cells = window.golCells = Array.from({ length: GOL_ROWS }, () => []);
/**
